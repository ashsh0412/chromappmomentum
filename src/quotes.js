...
function randomQuotest(){
    const randomQuotest = quotes[Math.floor(Math.random() * quotes.length)];
    quotespan.innerHTML = randomQuotest.quote;
    authorspan.innerHTML = `-${randomQuotest.author}-`;
}
